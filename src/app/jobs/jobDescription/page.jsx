        ...
        <div className="flex max-w-[800px] flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              Nurse to join our healthcare team in a hospital setting. As a
              nurse at our facility, you will have the opportunity to make a
              meaningful impact on the lives of patients and their families. We
              are committed to providing high-quality care and are looking for a
              dedicated professional to join our team.
            </p>
          </div>
          <div className="flex flex-col gap-2">
            <p className="text-xl font-bold"> Description</p>
