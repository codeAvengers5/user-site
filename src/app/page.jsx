...
export default function Home() {
  return <div className='w-full max-w-[100vw]'>
    {/*************************************************************  Hero Section ******************************************************************/}
    <section className="flex max-w-full h-full lg:min-h-[700px] flex-col items-start justify-start  bg-white text-left font-roboto text-xl text-white ">
      <div className='w-full h-[422px]'>
        ...
        <div className="z-8 box-border mx-[40px] mb-[20px] md:mx-[80px] flex  md:w-[703px] max-w-full h-full flex-row items-center pb-[50px] pt-0 text-white mq800:box-border mq800:pl-[37px] mq800:pr-[37px">
          <div className="flex w-full flex-wrap flex-col items-start justify-start gap-[10px]">
            <div className="z-2 box-border flex w-full md:w-[432px] max-w-full flex-row flex-wrap items-start justify-start ">
              <h1 className="text-heading_1 font-inherit font-bold relative m-0 inline-block max-w-full flex-1 leading-[50px] mq800:text-19xl mq800:leading-[40px] mq450:text-10xl mq450:leading-[30px]">
            ...
            <div className="flex w-full flex-row items-start justify-start self-stretch py-0 pr-0 text-xl">
              <div className="flex w-full flex-row flex-wrap items-start justify-start gap-[20px]">
                <div className="relative z-[2]  w-full md:min-w-[263px] max-w-full md:flex-1 mq450:text-base">{`Lorem ipsum dolor sit amet consectetur. Tellus velit ultrices bibendum `}</div>
      ...
      <div className="z-10 relative top-[-50px] flex flex-row flex-wrap items-center place-content-evenly w-full gap-y-[30px]">
        <FrameComponent />
        <FrameComponent />
        <FrameComponent />
        <FrameComponent />
    ...
    <section className='max-w-full min-h-[500px] items-start justify-start relative top-0 mt-[40px]'>
      <div className="box-border m-[40px] md:mx-[80px] flex  max-w-full flex-row items-center justify-center p-5 pb-1.5 pt-0 text-xl ">
        <div className="flex w-[1139px] h-full max-w-full flex-col md:flex-row items-start justify-center  md:gap-[60px] mq1125:flex-wrap mq800:gap-[10px_17px]">
          <img
    ...
    {/*************************************************************  Our project Section ******************************************************************/}
    <section className='max-w-full p-[20px] m-[40px] md:mx-[80px] min-h-[700px] mt-[40px] '>
      <div className="flex w-full flex-col  gap-[37px] mq800:gap-[18px_37px]">
        ...
        <div className="flex  max-w-full flex-col items-start justify-start gap-[20px]">
          <div className="box-border flex w-full flex-col md:flex-row items-start justify-start gap-[60px] bg-snow px-[49px] pb-[27px] pt-5 shadow-[0px_4px_4px_rgba(255,_0,_0,_0.2)] mq800:box-border mq800:pb-5">
            <img
            ...
            <div className="flex max-w-full h-full flex-col items-start justify-start gap-[40px]">
              <ErrorHandler />
              <div className="box-border flex w-full flex-row items-start justify-start px-9 py-0">
                <div className="flex w-full flex-wrap md:flex-row  place-content-center justify-between gap-[20px]">
                  <DataFlow
    ...
    {/*************************************************************  work by Section ******************************************************************/}
    <section className='max-w-full p-[20px] m-[40px] md:mx-[80px] min-h-[400px] mt-[40px]'>
      ...
      <div className="flex max-w-full flex-row items-start justify-between gap-[20px] self-stretch text-13xl mq1325:flex-wrap mq1325:justify-center">
        <div className="flex  max-h-[535px] w-[403px] max-w-full flex-col items-start justify-start gap-[22px]">
          <img
            className="relative [150px] sm:[200px] md:[300px] lg:h-[475px] max-w-full shrink-0 self-stretch overflow-hidden rounded-3xs object-cover"
            loading="lazy"
            alt=""
