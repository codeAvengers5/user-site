...
const Month202409September = () => {
  return (
    <div className="ml-[-1.2rem] flex h-[13.75rem] w-[13.75rem] flex-col items-center justify-start">
      <div className="box-border flex h-[1.75rem] shrink-0 flex-row items-start justify-center self-stretch overflow-hidden px-[4.562rem] pb-[0.25rem] pt-[0rem]">
        <FillYes1
          text="September"
          propBorder="unset"
...
export default Month202409September;
