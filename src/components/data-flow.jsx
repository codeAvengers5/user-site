...
const DataFlow = ({ group90, signalProcessor, propLeft }) => {
  ...
  return (
    <div className="flex flex-col items-start justify-start gap-[64px] text-left font-roboto text-17xl text-black">
      <div className="relative flex flex-row items-start justify-start">
        ...
        />
        <div className="relative z-[1] inline-block min-w-[68px] font-medium mq800:text-10xl mq450:text-3xl">
          {signalProcessor}
        </div>
      </div>
      <div className="flex flex-row items-start justify-start py-0 pl-[11px] pr-2.5 text-base">
