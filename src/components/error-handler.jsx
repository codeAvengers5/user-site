...
const ErrorHandler = ({ propPadding }) => {
  ...
  return (
    <div
      className=" flex w-full h-full flex-col items-start justify-start gap-[20px]  px-0 pb-[10px] pt-0 text-left font-roboto text-heading_1 text-black"
      ...
      <div className="flex w-full h-full flex-wrap items-start justify-start gap-[10px] font-inter text-base">
        <div className="flex h-full w-full md:min-w-[300px] 2xl:w-[800px] flex-wrap flex-col items-start justify-start gap-[13px] mq800:min-w-full">
