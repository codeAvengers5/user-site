...
const Footer = () => {
  return (
    <div className="box-border flex w-full flex-row flex-wrap items-center justify-center gap-[20px] self-stretch bg-darkslategray pb-0 pl-8 pr-9 pt-2.5 text-white sm:justify-between md:items-start ">
      ...
      <div className="flex flex-col items-start justify-start gap-[8px] pb-2.5 pl-[2.6000000000000227px] pr-[2.599999999999909px] pt-0 text-center">
        ...
        <div className="flex h-full w-full flex-col items-center justify-start gap-[15px] md:flex-row">
      ...
      <img
        className="relative h-[180px] max-w-full object-cover md:h-[217px] md:w-[329px]"
        loading="lazy"
        alt=""
