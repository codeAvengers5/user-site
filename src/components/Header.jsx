    ...
    <div className="sticky start-0 top-0 z-20 w-full">
      ...
      <section className="box-border flex flex-col flex-wrap items-start justify-between gap-[20px] self-stretch bg-darkslategray py-[1.5px] pl-8 pr-[35px] text-[#ffffff] md:flex-row">
        ...
        <div className="flex h-[51px] flex-col items-center justify-start px-0 pb-0  pt-[5px]">
          <button className="flex cursor-pointer flex-row items-start justify-start rounded-8xs bg-[#E71D36] px-[20px] py-[4px] [border:none] hover:bg-[#e71d35bb] md:px-[34.5px] md:py-[6.5px]">
      ...
      {/* the nav bar */}
      <div className="box-border flex max-w-full flex-row items-center  self-stretch bg-white text-black  mq1325:box-border  mq1125:box-border mq450:box-border">
